...
'   Se valor for igual a 1, a unidade est� no singular
    If WorksheetFunction.RoundDown(valor, 0) = 1 Then
'       a string da moeda no singular
        strMoeda = " real"
'       Se for maior que 1 a unidade est� no plural
...
'       acrescentar uma v�rgula antes do extenso
        cents = " e " & cents
    End If
...
'       a string centavos fica em branco
        centavos = ""
    Else
'       caso contr�rio, passar extenso das dezenas e concatenar
...
'   entre 11 e 19
    ...
    Else
'   Caso contr�rio, valor est� entre 20 e 90 inclusive
        If (intDezena > 1 And intUnidade > 0) Then
...
'   Se centena for cem, definir string como "cem " e sair
    If centena = 100 Then
        centoString = "cem "
    Else
'   Caso contr�rio definir a string da centena
        centoString = cento(tmpCento)
    End If
'   Avalia se a unidade � maior ou igual a zero, se o resto da unidade � igual ou
'   maior que zero, se a dezena � maior ou igual a um e se a centena � igual ou
...
'   Se for igual a 1, entao
 '   If '(tmpMilhar = 1) Then
'       string da milhar � igual a unidade e "mil"
...
'   Ver coment�rios para milhares acima
    ...
    If (tmpMilhao = 1) Then
        miString = unidades(tmpMilhao) & " milh�o, "
        ElseIf (tmpMilhao > 1 And tmpMilhao < 10) Then
            miString = unidades(tmpMilhao) & " milh�es, "
            ElseIf (tmpMilhao >= 10 And tmpMilhao < 100) Then
                miString = dezenas(tmpMilhao) & " milh�es, "
                ElseIf (tmpMilhao >= 100 And tmpMilhao < 1000) Then
                    miString = centenas(tmpMilhao) & " milh�es, "
    End If
    If milhao = 1000000# Then miString = "um milh�o de "
...
'   Ver coment�rios para milhares acima
    ...
    If (tmpBilhao = 1) Then
        biString = unidades(tmpBilhao) & " bilh�o, "
        ElseIf (tmpBilhao > 1 And tmpBilhao < 10) Then
            biString = unidades(tmpBilhao) & " bilh�es, "
            ElseIf (tmpBilhao >= 10 And tmpBilhao < 100) Then
                biString = dezenas(tmpBilhao) & " bilh�es, "
                ElseIf (tmpBilhao >= 100 And tmpBilhao < 1000) Then
                    biString = centenas(tmpBilhao) & " bilh�es, "
    End If
    If bilhao = 1000000000# Then biString = "um bilh�o de "
...
'   Ver coment�rios para milhares acima
    ...
    If (tmpTrilhao = 1) Then
        triString = unidades(tmpTrilhao) & " trilh�o, "
        ElseIf (tmpTrilhao > 1 And tmpTrilhao < 10) Then
            triString = unidades(tmpTrilhao) & " trilh�es, "
            ElseIf (tmpTrilhao >= 10 And tmpTrilhao < 100) Then
                triString = dezenas(tmpTrilhao) & " trilh�es, "
                ElseIf (tmpTrilhao >= 100 And tmpTrilhao < 1000) Then
                    triString = centenas(tmpTrilhao) & " trilh�es, "
    End If
    If Trilhao = 1000000000000# Then triString = "um trilh�o de "
